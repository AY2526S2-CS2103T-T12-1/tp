...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_AVAILABILITY_DESC, VolunteerAvailability.MESSAGE_CONSTRAINTS);
        assertParseFailure(parser, "1" + INVALID_RECORD_DESC, VolunteerRecord.MESSAGE_CONSTRAINTS);
